...
# introduction of pipe operator 
# conversion of RunnableSequence(prompt1,model,parser)   => this is used : prompt1 | model | parser
...
report_gen_chain = prompt | chat_model | parser
